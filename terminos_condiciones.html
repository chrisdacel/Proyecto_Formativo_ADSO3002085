...
<head>
    ...
    <link rel="icon" type="img/svg" href="./img/datos_operador/nature-svgrepo-com.svg">
    <title>Conexión EcoRisaralda</title>
    <link rel="stylesheet" href="./css/style_Terminos_Condiciones.css">
...
<body>
    ...
    <div id="separador" style="height: 20vh;"></div>
    ...
    <main>
        ...
        <div>
            <h2>3. Beneficios para turistas</h2>
            <p>
        ...
        <div>
            <h2>6. Modificaciones de los terminos y condiciones</h2>
            <p>
        ...
        <div>
            <h2>7. Limitación de responsabilidades</h2>
            <p>
